...
namespace BabyJournal
{
    ...
    /// </summary>
    public sealed partial class GalleryPage : BabyJournal.Common.LayoutAwarePage
    {
        public GalleryPage()
        {
        ...
        protected override void LoadState(Object navigationParameter, Dictionary<String, Object> pageState)
        {
            try
            {
                pageTitle.Text = (navigationParameter as GroupThumnail).Tag.ToString();

                var Items = App.AppDataFile.Items[pageTitle.Text];
        ...
        {
            this.Frame.Navigate(typeof(ItemDetailPage), (sender as ItemThumbnail).Tag);
        }
